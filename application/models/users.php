...
class users extends CI_Model {
	...
	public function get_user_by_id($id){
			return $this->db->query("SELECT id,first,last,email FROM users WHERE users.id=?",$id)->row_array();
	}
	...
	public function updateprofile($id){
		return $this->db->query("UPDATE users SET first=,last,email,password,orgname) WHERE users.id=?",$id);
	}
